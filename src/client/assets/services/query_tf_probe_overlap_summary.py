...
root_dir = '/var/www/eforge/tf/browser/src/client/assets/services'
data_dir = os.path.join(root_dir, 'data')
offsets_dir = '/net/seq/data/projects/eForge/www/tf/browser/src/client/assets/services/data/Illumina_850k_EPIC/aggregate/results/offsets'
...
probe_fns = {
  'Illumina_850k_EPIC' : 'MethylationEPIC_v-1-0_B4_tabs_hg19_final.bed.idsort.txt'
}

sample_md_fns = {
  'Illumina_850k_EPIC' : os.path.join(data_dir, 'Illumina_850k_EPIC/fp/filtered_sample_aggregates.json')
}
