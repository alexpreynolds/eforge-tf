...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      brandTitle: "eFORGE TF",
      brandSubtitle: "TF-centric methylation array probe browser",
        ...
        <div className="parent-container">
          ...
          <Panels panelSide="left-side" id="left-side-container" ref="leftSideContainer">
            ...
            <h6 className="description">About</h6>
              <p className="description">The <em>eFORGE TF</em> application is an adjunct to the <a href="https://eforge.altiusinstitute.org/">eFORGE</a> EWAS analysis tool. This enables the exploration of DNase I tag (chromatin accessibility) signal surrounding methylation array probes and the calculation of significance of overlap with transcription factor binding sites from common TF databases.</p>
            <hr />
