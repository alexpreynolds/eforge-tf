...
class Settings extends React.Component {
  ...
  renderSettings() {
    ...
    var query_probe_names = "https://eforge-tf.altiusinstitute.org/assets/services/query_probe_names.py";
...
*/
    ...
    var probesNotice = <p className='panel-label-notice noselect'>Probe IDs may be separated by commas or newline characters (max. 1000)</p>
      
    var paddingNotice = <p className='panel-label-notice noselect'>Padding (nt) around the probe genomic location</p>
    ...
    var viewModeNotice = <p className='panel-label-notice noselect'>View <em><strong>associations</strong></em> of transcription factors (TF) and footprints with an individual probe, or a <em><strong>summary</strong></em> of TF associations over all probes, with positional overlap of selected probes with associated TFs</p>
    ...
    var annotationNotice = <p className='panel-label-notice noselect'>Display probe-specific or all transcription factor overlaps ("All" can increase query time)</p>
    ...
    return (
      <div className="settings">
        <div className="settings-container">
          ...
          <p className="settings-item-title">Array</p>
          <div>{arraySelect}</div>
          ...
          <p className="settings-item-title settings-item-padding-title">Probe IDs</p>
          <div>{probeInput}</div>
          {probesNotice}
