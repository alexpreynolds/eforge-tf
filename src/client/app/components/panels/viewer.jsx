...
class Viewer extends React.Component {
  ...
  updateAssociationData() {
    ...
    var single_sample_query = "https://eforge-tf.altiusinstitute.org/assets/services/query.py";
    var aggregate_sample_query = "https://eforge-tf.altiusinstitute.org/assets/services/query_aggregate.py";
  ...
  updateSummaryData() {
    ...
    var tf_summary_query = "https://eforge-tf.altiusinstitute.org/assets/services/query_tf_summary.py";
    var self = this;
  ...
  updateSelectedTF(rowInfo) {
    ...
    this.setState({
      ...
      var tf_aggregate_summary_query = "https://eforge-tf.altiusinstitute.org/assets/services/query_tf_aggregate_summary.py";
      var self = this;
      axios.post(tf_aggregate_summary_query, { tf_aggregate_summary })
        .then(
          agg_result => {
            ...
            var tf_probe_overlap_query = "https://eforge-tf.altiusinstitute.org/assets/services/query_tf_probe_overlap_summary.py";
    ...
    if (this.props.settings && (this.props.settings.probesCount >= 1)) {
      return (
        <div className="viewer-gallery-header" id="viewer-gallery-header">
          ...
          <div className="viewer-gallery-header-title">Probe TF and Footprint Associations</div>
          <div>
